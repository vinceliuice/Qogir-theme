...
install() {
  ...
  local THEME_DIR=${DEST_DIR}/${name}${color}
  ...
  echo "Name=Canta${color}" >> ${THEME_DIR}/index.theme
  echo "Comment=An Clean Gtk+ theme based on Flat Design" >> ${THEME_DIR}/index.theme
  echo "Encoding=UTF-8" >> ${THEME_DIR}/index.theme
  echo "" >> ${THEME_DIR}/index.theme
  echo "[X-GNOME-Metatheme]" >> ${THEME_DIR}/index.theme
  echo "GtkTheme=Canta${color}" >> ${THEME_DIR}/index.theme
  echo "MetacityTheme=Canta${color}" >> ${THEME_DIR}/index.theme
